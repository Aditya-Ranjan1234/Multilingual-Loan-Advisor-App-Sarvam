...
export const uiTranslations: UITranslations = {
  'app.title': {
    ...
    'pa-IN': 'ਨਿੱਜੀ ਲੋਨ ਸਹਾਇਕ',
    'ta-IN': 'தனிப்பட்ட கடன் உதவியாளர்',
    'te-IN': 'వ్యక్తిగత రుణ సహాయకుడు'
  },
  'app.name': {
    'en-IN': 'Loan Genius',
    'hi-IN': 'लोन जीनियस',
  ...
  'calculator.subtitle': {
    ...
    'hi-IN': 'अपनी आय के आधार पर पता करें कि आप कितने लोन के लिए पात्र हैं।',
    'bn-IN': 'আপনার আয়ের উপর ভিত্তি করে আপনি কত ঋণের জন্য যোগ্য তা গণনা করুন।',
    'gu-IN': 'તમારી આવક પર આધારિત તમે કેટલા લોન માટે પાત્ર છો તે ગણતરી કરો.',
    'kn-IN': 'ನಿಮ್ಮ ಆದಾಯದ ಆಧಾರದ ಮೇಲೆ ನೀವು ಎಷ್ಟು ಸಾಲಕ್ಕೆ ಅರ್ಹರಾಗಿದ್ದೀರಿ ಎಂದು ಲೆಕ್ಕ ಮಾಡಿ.',
    ...
    'pa-IN': 'ਆਪਣੀ ਆਮਦਨੀ ਦੇ ਆਧਾਰ \'ਤੇ ਗਣਨਾ ਕਰੋ ਕਿ ਤੁਸੀਂ ਕਿੰਨੇ ਲੋਨ ਲਈ ਯੋਗ ਹੋ।',
